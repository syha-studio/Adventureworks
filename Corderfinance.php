...
// Chart Order and Income
    ...
    while($row = mysqli_fetch_array($datasub2)){
        ...
        $query = mysqli_query($conn,"SELECT SUM(LineTotal) AS 'Total Incomes', SUM(OrderQty) AS 'Total Order', years
                                        FROM sales_fact s
                                        JOIN time p ON (s.time_key=p.id) 
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <!-- Begin Page Content -->
                <div class="container-fluid">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1  class="h3 mb-2 text-gray-800">Sales - Ordering and Financial : <?php if ( isset($_POST["cari2"])){echo $_POST["keyword2"];} else echo 'All'?></h1>
                    <!-- Pencarian -->
                    ...
                    <!-- Area Chart DrillDown -->
                        ...
                        <div class="col-xl-6 col-lg-5">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Trend Incomes</h6>
                                </div>
                                <div class="d-flex justify-content-center">
                                    <figure class="highcharts-figure">
                                        <div id="IpC"></div>
